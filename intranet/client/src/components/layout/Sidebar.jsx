...
function Sidebar({ classes, staticContext, location, isExpanded, ...rest }) {
  ...
  return (
    <Drawer variant="permanent" {...rest}>
      <Brand>
        <BrandIcon />
        {isExpanded ? <Box ml={1}>FAV.Intranet</Box> : ""}
      </Brand>
      <Scrollbar>
        <List disablePadding>
          <Items>
                ...
                {category.children ? (
                  <React.Fragment key={index}>
                    <SidebarCategory
                      ...
                      isCollapsable={false}
                      name={isExpanded ? category.id : null}
                      icon={category.icon}
                      button={true}
                      ...
                      {isExpanded
                        ? category.children.map((route, index) => (
                            <SidebarLink
                              key={index}
                              name={route.name}
                              // name={isExpanded ? route.name : null}
                              to={route.path}
                              icon={route.icon}
                              badge={route.badge}
                            />
